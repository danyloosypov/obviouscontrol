    ...
    <ul class="navbar-nav navbar-nav-right">
      ...
      <li class="nav-item nav-profile dropdown">
        ...
        <div class="dropdown-menu navbar-dropdown dropdown-menu-right p-0 border-0 font-size-sm" aria-labelledby="profileDropdown" data-x-placement="bottom-end">
          ...
          <div class="p-2">
            <h5 class="dropdown-header text-uppercase pl-2 text-dark"><?php echo $translations['options-navbar-title']['content'] ?></h5>
            ...
            <h5 class="dropdown-header text-uppercase  pl-2 text-dark mt-2"><?php echo $translations['actions-navbar-title']['content'] ?></h5>
            <a class="dropdown-item py-1 d-flex align-items-center justify-content-between" href="logout.php">
              <span><?php echo $translations['logout-title']['content'] ?></span>
