      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row">
            ...
            <br>
            <br>
            <form action="generate_excel.php?id=<?php echo $id ?>" method="POST" id="export-form">
              <div class="form-control">
                <input type="hidden" name="sen_id" value="<?php echo $id ?>"/>
                <input type="date" name="datestart"/>
                <input type="date" name="dateend"/>
                <input type="submit" id="export-to-excel" value="Export to excel"/>
              </div>
            </form>
            <br>
            <br>
